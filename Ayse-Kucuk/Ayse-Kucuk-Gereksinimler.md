...
4. **Şifre Sıfırlama** (Ayşe Küçük)
   ...
   - **Açıklama:** Sistem, kullanıcıların ve mekan sahiplerinin şifrelerini unutmaları durumunda profil kısmından şifre sıfırlamalıdır. Doğrulama sonrasında kullanıcı ve mekan sahibi yeni bir şifre belirleyebilmelidir.
